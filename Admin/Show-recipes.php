        ...
        while ($row = mysqli_fetch_array($Rowbuy)) {
            echo '
                <div class="wrapper flex-item">
                    <div class="container">
                        <div class="top"><img style="width: 200px; height: 200px; margin: 0px auto; display: flex; justify-content: center; align-items: center;" src="Site-management/IMG-AAdmin/' . htmlspecialchars($row['recipe_img']) . '" alt="صورة الوصفة"></div>
                        <div class="bottom">
                            <div class="details">
