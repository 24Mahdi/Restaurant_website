        ...
        <div class="app-main">
            ...
            <div class="container">
                ...
                <form action="" method="post" enctype="multipart/form-data" style="direction: rtl;margin: auto;
                    ...
                    <div class="row">
                        <h4 style="font-size: 1.3rem;">أضافة وصفة</h4>

                        <?php echo isset($Error) ? $Error : ''; ?>
                        <?php echo isset($Success) ? $Success : ''; ?>
                        <div class="input-group input-group-icon">
                            <input name="get01" class="stylr-input" type="text" placeholder="أسم الوصفة">

                        </div>
                        <div class="input-group input-group-icon">
                            <input name="get02" class="stylr-input" type="text" placeholder="مكونات الوصفة">
                        </div>
                        <style>
                            .Style-text {
                                font-size: 1rem;
                        ...
                        <div class="input-group input-group-icon">
                            <textarea placeholder="طريقة التحضير" name="get03" class="Style-text stylr-input"></textarea>
                        </div>
                    </div>
                    <div class=" row">
                        <div class="col-half">
                            <h4 style="font-size: 1.3rem;    text-align: right;">صورة الوصفة</h4>
                            <div class="col-third" style="    width: 100%;">
                                <input name="show_img2" style="font-size: 1rem;" type="file" placeholder="اضف الصورة">
                            </div>
                        </div>
