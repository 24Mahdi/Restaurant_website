            ...
            <div class="products-wrapper">
                <div class="products">
                    ...
                    while ($row = mysqli_fetch_array($Rowbuy)) {
                        echo '
        <div class="product">
            <img src="../Admin/Site-management/IMG-AAdmin/' . htmlspecialchars($row['product_img']) . '" alt="منتج 2">
            ...
            <div class="row" style="padding: 2rem;">
                ...
                while ($Runshow = mysqli_fetch_array($RunShow)) {
                    if ($i < 6) {
                        echo '   <div class="item">
                    <div class="media-box">
                        <img src="../Admin/Site-management/IMG-AAdmin/' . $Runshow['Devices_img'] . '" alt="BODY BUILDING CLASSES" class="img-fluid">
                    </div>
                    <div class="body-box">
