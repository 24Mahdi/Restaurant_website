    ...
    <div class="flex-container">
        ...
        while ($row = mysqli_fetch_array($Rowbuy)) {
            ...
            <div class="wrapper flex-item">
                <div class="container">
                    <div class="top"><img style="width: 200px;height: 200px;margin: 0px auto;display: flex;justify-content: center;align-items: center;" src="../Admin/Site-management/IMG-AAdmin/' . htmlspecialchars($row['product_img']) . '" alt=""></div>
                    <div class="bottom">
                        <div class="details">
